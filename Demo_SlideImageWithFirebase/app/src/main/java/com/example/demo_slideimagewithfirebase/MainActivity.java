...
import com.example.demo_slideimagewithfirebase.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void pickImage(ActivityResultLauncher<Intent> launcher) {
        ...
        ImagePicker.Companion.with(this)
                .saveDir(MainActivity.this.getExternalFilesDir(Environment.DIRECTORY_PICTURES))
                .galleryOnly()
