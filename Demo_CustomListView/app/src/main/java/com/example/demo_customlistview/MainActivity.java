...
import com.example.demo_customlistview.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageList = {R.drawable.image_pasta, R.drawable.image_maggi, R.drawable.image_cake, R.drawable.image_pancake, R.drawable.image_pizza, R.drawable.image_burger, R.drawable.image_fries};
